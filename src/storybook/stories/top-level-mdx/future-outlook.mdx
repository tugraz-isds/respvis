...
- Parcoord: On mobile devices: Inversion Arrow is displayed vertically and at wrong location.
- Parcoord: On mobile devices: Filter Elements are hardly controllable. Maybe remove for mobile devices,
