...
For a live demonstration of how certain RespVis arguments can make use of
breakpoints, take a look at
[Chart Arguments](?path=/docs/respvis-arguments-chart-arguments--docs).


## <a name="using-defined-breakpoints-in-css"></a> Using Defined Breakpoints in CSS
...
## <a name="controlling-layout-widths-with-css-variables"></a> Controlling Layout Widths with CSS Variables
...
[Controlling Layout Widths with CSS Variables](#using-defined-breakpoints-in-css)
