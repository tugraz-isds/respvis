...
of the library in ES format. This bundle contains and exports also
...
Then one can start to create his project. This tutorial begins from scratch and explains
...
one should have created the following files and directories:
