...
webpack, rollup or parcel will additionally ease the usage of TypeScript
with plain HTML.
...
<Source code={`
import { LineChart, LineChartUserArgs, formatWithDecimalZero } from 'respvis';
...
When serving the index.html file by running `npx parcel ./chart/line-chart.html`
from the root directory one will see the fruits of him/her work already:
