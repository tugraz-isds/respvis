...
import {concatCodeSnippets} from "../../../../util/concatCodeSnippets";
...
[Axis Arguments](?path=/docs/using-respvis-arguments-axis-arguments-base-axis-arguments--docs)
...
[Axis Arguments](?path=/docs/using-respvis-arguments-axis-arguments-base-axis-arguments--docs) but
really come to the fore when being applied in
[Cartesian Charts](?path=/docs/using-respvis-charts-chart-examples-cartesian-charts--cartesian-charts).
