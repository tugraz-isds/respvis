...
type ScaledValuesCategorical = { values: ToArray<string>, scale?: ScaleBand<string> }

export type ScaledValuesArg<Domain> =
  Domain extends Date ? ScaledValuesDate :
  Domain extends number ? ScaledValuesLinear :
  Domain extends string ? ScaledValuesCategorical : never
...
export type ScaledValuesValid<Domain> =
  Domain extends Date ? Required<ScaledValuesDate> :
    Domain extends number ? Required<ScaledValuesLinear> :
      Domain extends string ? Required<ScaledValuesCategorical> & {}: never
...
export function isScaledValuesCategorical(arg: ScaledValuesValid<any>) : arg is Required<ScaledValuesCategorical> {
